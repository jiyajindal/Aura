...
var app_id = "GcXnPIXDpUDVlnAAfoHY";
var app_code = "R3DRycnyH4iWr9cW0t-v9CH-3uUSL3NC1yOKVWLa1kQ";
...
let provider = new H.datalens.RawDataProvider({
    ...
    dataUrl: 'https://blistersun.github.io/Aura/Spatial_dataset.csv',
    dataToFeatures: (data, helpers) => {
        ...
        for (let i = 1; i < parsed.length; i++) {
            ...
            let feature = {
                ...
                "geometry": {
                    "type": "Point",
                    "coordinates": [Number(row[2]), Number(row[3])]
                },
                "properties": {
                    "pollutant": row[20]
                }
